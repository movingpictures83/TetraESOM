...
my $lrnfile = $prefix."_".$seqfile."_$min_length\.lrn";
my $namesfile = $prefix."_".$seqfile."_$min_length\.names";
my $classfile = $prefix."_".$seqfile."_$min_length\.cls";
